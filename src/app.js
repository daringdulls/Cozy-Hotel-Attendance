    ...
    <div class="shell">
      <aside>
        ...
        <nav class="hr-nav">
          ...
          <details><summary><span>${icon('team')}</span>Team <b>+</b></summary><div><button data-module="Departments and teams">Departments & teams</button><button data-module="Organisation chart">Organisation chart</button></div></details>
